...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="PRASMESTI.css">
	</head>
	...
	<body>
		...
		<p><!--Include du titre h1-->
			<h1>
				<?php include '../Ancien_Site/titre_h1.php';?>
			</h1>
		</p><!--Fin Include du titre h1-->
		<p>
			<?php include '../Ancien_Site/barreNavigation.php'?>
		</p>
		<!--Fin du corps commun à toutes les pages-->

		<!--Début du corps unique à la page-->
		<p>
			<div class="corpsPresentation">
				<div class="presentation" id="presentationElement1">
					<br />
				...
				<div class="presentation" id="presentationElement2">
					<br />
					<h4>Description :</h4>
				...
				<div class="presentation" id="presentationElement3">
					<br />
				...
				<div class="presentation" id="presentationElement4">
					<br />
