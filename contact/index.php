                ...
                <div class="row gx-60 gy-40">
                    <div class="col-xl-4 col-lg-5">
                        ...
                        <div class="contact-feature">
                            ...
                            <div class="media-body">
                                ...
                                <p class="box-text"><a href="tel:16363599852">+241 36 54 78 96</a></p>
                            </div>
                        </div>
                        <div class="contact-feature">
                            ...
                            <div class="media-body">
                                ...
                                <p class="box-text"><a href="mailto:allinfo@donet.com">contact@prasmesti.com</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-8 col-lg-7">
                        <div class="contact-map">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d127671.0273572411!2d9.425473021873623!3d0.40304587899062777!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sCommunaut%C3%A9%20%C3%89conomique%20des%20%C3%89tats%20de%20l&#39;Afrique%20Centrale!5e0!3m2!1sfr!2sga!4v1732020180077!5m2!1sfr!2sga"
                        ...
                        <div class="contact-form-v1 contact-page-form">
                            <form action="#" method="POST" class="contact-form style-border ajax-contact">
                                <div class="row">
                                    ...
                                    <div class="form-group style-border col-12">
                                        <input type="number" class="form-control" name="number" id="number" placeholder="Numéro de téléphone">
                                    </div>
                                    <div class="form-group style-border col-12">
                                        <textarea name="message" id="message" cols="30" rows="3" class="form-control" placeholder="Message"></textarea>
                                    </div>
                                    <div class="form-btn col-12">
                                        <button class="th-btn">Envoyer</button>
                                    </div>
                                </div>
