                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="javascript: void(0);" data-key="t-inbox">Ajout d'un document</a></li>
                                <li><a href="javascript: void(0);" data-key="t-read-email">Liste des documents</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="javascript: void(0);">Liste des documents</a></li>
                            </ul>
                        </li>
                                            ...
                                            <div>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar">
                                                        <div class="avatar-title rounded bg-primary-subtle ">
                                                            <i
                                                                class="bx bx-folder-open font-size-24 mb-0 text-primary"></i>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex mt-1 align-items-end overflow-hidden">
                                                        <div class="flex-grow-1">
                                                            <p class="text-muted mb-0 text-truncate">Projets financés
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div>
                                                    <h4 class="mt-4 pt-1 mb-0 font-size-22">78%<span
                                                            class="text-danger fw-medium font-size-13 align-middle"> <i
                                                                class="mdi mdi-arrow-down"></i> 2.64% </span> </h4>
                                                    <div class="d-flex mt-1 align-items-end overflow-hidden">
                                                        <div class="flex-grow-1">
                                                            <p class="text-muted mb-0 text-truncate">Taux
                                                                d’alphabétisation des adultes</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div>
                                                    <h4 class="mt-4 pt-1 mb-0 font-size-22">6482 <span
                                                            class="text-success fw-medium font-size-13 align-middle"> <i
                                                                class="mdi mdi-arrow-down"></i> 5.79% </span> </h4>
                                                    <div class="d-flex mt-1 align-items-end overflow-hidden">
                                                        <div class="flex-grow-1">
                                                            <p class="text-muted mb-0 text-truncate">Nombre
                                                                d'enseignants formés cette année</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
