...
export const implementationCountries: CountryConfig[] = [
  {
    ...
    ministryFr: 'Ministere de l\'Education',
    ...
    actions: [
      {
        ...
        labelFr: 'Deploiement des laboratoires STEM provinciaux',
        ownerEn: 'MED',
        ownerFr: 'MED',
        status: 'progress',
        due: 'Oct 2026',
  ...
  },
  {
    ...
    ministryFr: 'Ministere de l\'Education et de la Recherche Scientifique',
    ...
    actions: [
      {
        ...
        labelFr: 'Numerisation des salles de classe primaires rurales',
        ownerEn: 'MENRS',
        ownerFr: 'MENRS',
        status: 'progress',
        due: 'Nov 2026',
      },
      {
        ...
        labelFr: 'Revision du curriculum STEM en Kirundi',
      ...
      },
      {
        ...
        labelFr: 'Reseau de points focaux provinciaux',
        ownerEn: 'PRASMESTI focal point',
        ownerFr: 'Point focal PRASMESTI',
        status: 'planned',
        due: 'Mar 2027',
  ...
  },
  {
    ...
    ministryFr: 'Ministere de l\'Education de Base',
    ...
    actions: [
      ...
      },
      {
        ...
        labelFr: 'Plan de formation continue des enseignants - regions nord',
        ownerEn: 'Statistics Unit',
        ownerFr: 'Unite statistique',
        status: 'risk',
        due: 'Dec 2026',
      },
      {
        ...
        labelFr: 'Pont universite - centre d\'innovation',
        ownerEn: 'PRASMESTI focal point',
        ownerFr: 'Point focal PRASMESTI',
        status: 'planned',
        due: 'Mar 2027',
  ...
  },
  {
    ...
    ministryFr: 'Ministere de l\'Education Nationale',
    ...
    actions: [
      {
        ...
        labelFr: 'Systeme de collecte de donnees au niveau prefectoral',
        ownerEn: 'MEN',
        ownerFr: 'MEN',
        status: 'progress',
        due: 'Oct 2026',
  ...
  },
  {
    ...
    ministryFr: 'Ministere de l\'Enseignement Primaire et Secondaire',
    ...
    actions: [
      {
        ...
        labelFr: 'Programme de connectivite des ecoles riveraines',
        ownerEn: 'MEPSA',
        ownerFr: 'MEPSA',
        status: 'progress',
        due: 'Sep 2026',
    ...
    actions: [
      {
        ...
        labelFr: 'Kit d\'evaluation scolaire trilingue (es/fr/pt)',
        ownerEn: 'MINEDU',
        ownerFr: 'MINEDU',
        status: 'progress',
        due: 'Oct 2026',
      },
      {
        ...
        labelFr: 'Harmonisation des donnees continent - iles',
        ownerEn: 'Statistics Unit',
        ownerFr: 'Unite statistique',
        status: 'risk',
        due: 'Dec 2026',
  ...
  },
  {
    ...
    ministryFr: 'Ministere de l\'Enseignement Primaire, Secondaire et Technique',
    ...
    actions: [
      {
        ...
        labelFr: 'Entrepot de donnees educatives provincial',
        ownerEn: 'MINEPST',
        ownerFr: 'MINEPST',
        status: 'progress',
        due: 'Nov 2026',
      },
      {
        ...
        labelFr: 'Plan de continuite des enseignants en zone de conflit',
        ownerEn: 'Statistics Unit',
        ownerFr: 'Unite statistique',
        status: 'risk',
        due: 'Feb 2027',
      },
      {
        ...
        labelFr: 'Laboratoires STI mobiles pour provinces eloignees',
        ownerEn: 'PRASMESTI focal point',
        ownerFr: 'Point focal PRASMESTI',
        status: 'planned',
        due: 'May 2027',
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        labelFr: 'Deploiement national des olympiades STEM',
        ownerEn: 'Statistics Unit',
        ownerFr: 'Unite statistique',
        status: 'planned',
        due: 'Oct 2026',
  ...
  },
  {
    ...
    ministryFr: 'Ministere de l\'Education, de la Culture et des Sciences',
    ...
    actions: [
      {
        ...
        labelFr: 'Mise a jour du recensement scolaire des iles',
        ownerEn: 'MECC',
        ownerFr: 'MECC',
        status: 'progress',
        due: 'Sep 2026',
      },
      {
        ...
        labelFr: 'Echange d\'enseignants STEM lusophones',
        ownerEn: 'Statistics Unit',
        ownerFr: 'Unite statistique',
        status: 'risk',
        due: 'Dec 2026',
      },
      {
        ...
        labelFr: 'Programme de sciences du climat cotier',
        ownerEn: 'PRASMESTI focal point',
        ownerFr: 'Point focal PRASMESTI',
        status: 'planned',
        due: 'Feb 2027',
