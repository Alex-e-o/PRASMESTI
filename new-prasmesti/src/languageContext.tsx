...
const translations: Dictionary = {
  ...
  implEyebrow: { en: 'Monitoring', fr: 'Suivi' },
  implTitle: { en: 'Implementation Status', fr: 'État de mise en œuvre' },
  implSubtitle: {
  ...
  implCountriesEyebrow: { en: 'Member States', fr: 'États membres' },
  implCountriesTitle: { en: 'ECCAS member states', fr: 'États membres de la CEEAC' },
  implStatusActive: { en: 'Active', fr: 'En cours' },
