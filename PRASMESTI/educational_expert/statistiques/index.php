            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="page-title-box align-self-center d-none d-md-block">
                        <h4 class="page-title mb-0">Statistiques</h4>
                    </div>
                    <!-- end page title -->
        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!-- Line Chart: Evolution des Projets -->
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                        ...
                        <!-- Bar Chart: Répartition du Budget -->
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                    ...
                    <!-- Pie Chart: Répartition Géographique des Projets -->
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                        ...
                        <!-- Donut Chart: Statut des Projets -->
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                    ...
                    <!-- Polar Chart: Evaluation des Risques -->
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                        ...
                        <!-- Radar Chart: Compétences du Personnel -->
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
