!function () {
    ...
    function r(e) {
        document.querySelectorAll(".header-lang-img").forEach(function (t) {
            if (t) {
                switch (e) {
                    case "eng": t.src = "assets/images/flags/us.jpg"; break;
                    case "sp": t.src = "assets/images/flags/spain.jpg"; break;
                    case "gr": t.src = "assets/images/flags/germany.jpg"; break;
                    case "it": t.src = "assets/images/flags/italy.jpg"; break;
                    case "ru": t.src = "assets/images/flags/russia.jpg"; break;
                    default: t.src = "assets/images/flags/us.jpg"
                }
                localStorage.setItem("language", e), o = localStorage.getItem("language"), function () {
                    ...
                    t.open("GET", "assets/lang/" + o + ".json"), t.onreadystatechange = function () {
                        ...
                        4 === this.readyState && 200 === this.status && (a = JSON.parse(this.responseText), Object.keys(a).forEach(function (e) {
                            document.querySelectorAll("[data-key='" + e + "']").forEach(function (t) { t.textContent = a[e] })
                        }))
                    }, t.send()
                }()
            }
    ...
    function d() {
        setTimeout(function () {
            ...
            s && (t = s.querySelector(".mm-active .active"), 300 < (e = t ? t.offsetTop : 0) && (e -= 100, (a = document.getElementsByClassName("vertical-menu") ? document.getElementsByClassName("vertical-menu")[0] : "") && a.querySelector(".simplebar-content-wrapper") && setTimeout(function () { a.querySelector(".simplebar-content-wrapper").scrollTop = e }, 0)))
        }, 0)
    }
    function c() {
    ...
    window.onload = function () { document.getElementById("preloader") && (u("pre-status"), u("preloader")) }, m(), document.addEventListener("DOMContentLoaded", function (t) { document.getElementById("side-menu") && new MetisMenu("#side-menu") }), i(), function () {
